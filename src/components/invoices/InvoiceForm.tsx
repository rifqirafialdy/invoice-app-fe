  ...
  const onSubmit = async (data: InvoiceFormData) => {
    try {
      if (invoice) {
        ...
        setSuccessState({ isOpen: true, title: 'Invoice Updated!', description: 'Your changes have been saved.' });
      } else {
        await invoiceApi.create(data);
        setSuccessState({ isOpen: true, title: 'Invoice Created!', description: 'The new invoice is now available.' });
      }
    } catch (error: any) {
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        description={`Are you sure you want to ${isEditMode ? 'update this invoice' : 'create this new invoice'}?`}
